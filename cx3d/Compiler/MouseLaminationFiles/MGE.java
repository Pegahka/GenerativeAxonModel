...
public class MGE extends GeneNetworkMachine
{
	...
	public void run() {
		...
		{
			instantiate(new MoveTangentially(CtxConstants.L6,new Color(255,128,128)));
		...
		{
			instantiate(new MoveTangentially(CtxConstants.L5,new Color(128,255,128)));
				...
				).eval())
		{
			...
			{
				writeMorphProperty("count", "GE_4");
				instantiate(new MoveTangentially(CtxConstants.L4,new Color(128,128,255)));
				kill();
			}
				...
				).eval())
		{
			...
			{
				instantiate(new MoveTangentially(CtxConstants.L23,new Color(128,255,255)));
				kill();
			}
		}		
